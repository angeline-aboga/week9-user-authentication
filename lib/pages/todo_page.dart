...
class _TodoPageState extends State<TodoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Stream<User?> userStream= context.watch<UserAuthProvider>().uStream;
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            return Scaffold(
              ...
              body: const Text("nagiging stuck po sa loading screen and since di ko po mapagana dinisable ko na lang"),
            );            
          } 
